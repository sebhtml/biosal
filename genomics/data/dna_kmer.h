...
int biosal_dna_kmer_unpack(struct biosal_dna_kmer *self,
                void *buffer, int kmer_length, struct core_memory_pool *memory, struct biosal_dna_codec *codec);
...
int biosal_dna_kmer_pack_unpack(struct biosal_dna_kmer *self,
                void *buffer, int operation, int kmer_length, struct core_memory_pool *memory,
