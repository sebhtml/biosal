...
void biosal_dna_kmer_destroy(struct biosal_dna_kmer *sequence, struct biosal_memory_pool *memory)
{
...
{
    return biosal_dna_kmer_pack_unpack(sequence, NULL, BIOSAL_PACKER_OPERATION_PACK_SIZE,
...
{
    return biosal_dna_kmer_pack_unpack(sequence, buffer, BIOSAL_PACKER_OPERATION_UNPACK, kmer_length, memory, codec);
}
...
{
    return biosal_dna_kmer_pack_unpack(sequence, buffer, BIOSAL_PACKER_OPERATION_PACK, kmer_length, NULL, codec);
}
                ...
                struct biosal_memory_pool *memory, struct biosal_dna_codec *codec)
{
     ...
     */
#if 0
    biosal_packer_process(&packer, kmer_length, sizeof(kmer_length));
#endif
        ...
        struct biosal_dna_codec *codec, struct biosal_memory_pool *memory)
{
    ...
    dna = (char *)biosal_memory_pool_allocate(memory, kmer_length + 1);
                ...
                struct biosal_memory_pool *memory, struct biosal_dna_codec *codec)
{
    ...
    encoded_length = biosal_dna_codec_encoded_length(codec, kmer_length);
    self->encoded_data = biosal_memory_pool_allocate(memory, encoded_length);
    biosal_memory_copy(self->encoded_data, other->encoded_data, encoded_length);
}
                ...
                struct biosal_dna_codec *codec, struct biosal_memory_pool *memory)
{
    ...
    dna_sequence = biosal_memory_pool_allocate(memory, kmer_length + 1);
                ...
                struct biosal_dna_codec *codec)
{
     ...
     */
#if 0
    hash = biosal_hash_data_uint64_t(self->encoded_data, kmer_length, seed);
    ...
    /*hash = biosal_hash_data_uint64_t(sequence, kmer_length, seed);*/

    hash = biosal_hash_data_uint64_t(self->encoded_data, encoded_length, seed);
/*
    printf("%s %" PRIu64 "\n", sequence, hash);
    b1sal_free(sequence);
*/
                ...
                struct biosal_dna_codec *codec, struct biosal_memory_pool *memory)
{
    ...
    sequence = biosal_memory_pool_allocate(memory, kmer_length + 1);
    ...
    biosal_memory_pool_free(memory, sequence);
    sequence = NULL;
#endif
}
...
int biosal_dna_kmer_get_symbol(struct biosal_dna_kmer *self, int position,
                int kmer_length, struct biosal_dna_codec *codec)
{
    BIOSAL_DEBUGGER_ASSERT(position >= 0);
    BIOSAL_DEBUGGER_ASSERT(position < kmer_length);
