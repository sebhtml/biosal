 ...
 */
#define BSAL_SEQUENCE_STORE_PRODUCT_BLOCK_SIZE_DISTRIBUTED 32
#define BSAL_SEQUENCE_STORE_PRODUCT_BLOCK_SIZE_ONE_NODE BSAL_SEQUENCE_STORE_PRODUCT_BLOCK_SIZE_DISTRIBUTED
