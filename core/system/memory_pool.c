 ...
 * Some flags.
 */
#define FLAG_ENABLE_TRACKING                CORE_BITMAP_MAKE_FLAG(0)
#define FLAG_DISABLED                       CORE_BITMAP_MAKE_FLAG(1)
#define FLAG_ENABLE_SEGMENT_NORMALIZATION   CORE_BITMAP_MAKE_FLAG(2)
#define FLAG_ALIGN                          CORE_BITMAP_MAKE_FLAG(3)
#define FLAG_EPHEMERAL                      CORE_BITMAP_MAKE_FLAG(4)
#define FLAG_ENABLE_TRACEPOINTS             CORE_BITMAP_MAKE_FLAG(5)
