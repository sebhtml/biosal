...
#define BSAL_DISPLAY_COUNTER(counter, spacing, name) \
...
void bsal_counter_print(struct bsal_counter *self, int name)
{
     ...
     */
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_SPAWNED_ACTORS, "", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_KILLED_ACTORS, "", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_BALANCE_ACTORS, " balance ", name);

    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_RECEIVED_MESSAGES, "", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_RECEIVED_MESSAGES_FROM_SELF, "  ", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_RECEIVED_MESSAGES_NOT_FROM_SELF, "  ", name);

    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_SENT_MESSAGES, "", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_SENT_MESSAGES_TO_SELF, "  ", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_SENT_MESSAGES_NOT_TO_SELF, "  ", name);

    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_BALANCE_MESSAGES, " balance ", name);

    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_RECEIVED_BYTES, "", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_RECEIVED_BYTES_FROM_SELF, "  ", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_RECEIVED_BYTES_NOT_FROM_SELF, "  ", name);

    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_SENT_BYTES, "", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_SENT_BYTES_TO_SELF, "  ", name);
    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_SENT_BYTES_NOT_TO_SELF, " ", name);

    BSAL_DISPLAY_COUNTER(BSAL_COUNTER_BALANCE_BYTES, " balance ", name);
}
