...
#define BSAL_SET_CONSUMER 0x000020a9
#define BSAL_SET_CONSUMER_REPLY 0x00004db0

#define BSAL_SET_CONSUMERS 0x0000671d
#define BSAL_SET_CONSUMERS_REPLY 0x000071e4
