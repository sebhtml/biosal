...
#define THORIUM_MESSAGE_TRACEPOINT_ACTOR_1_SEND         0
#define THORIUM_MESSAGE_TRACEPOINT_WORKER_1_SEND        1
#define THORIUM_MESSAGE_TRACEPOINT_NODE_1_SEND          2
#define THORIUM_MESSAGE_TRACEPOINT_NODE_2_RECEIVE       3
#define THORIUM_MESSAGE_TRACEPOINT_WORKER_2_RECEIVE     4
#define THORIUM_MESSAGE_TRACEPOINT_ACTOR_2_RECEIVE      5
