...
void thorium_node_init(struct thorium_node *node, int *argc, char ***argv)
{
     ...
     * Tracepoint session
     */
    thorium_tracepoint_session_init(&node->tracepoint_session);
    thorium_tracepoint_session_add_tracepoint(&node->tracepoint_session,
...
void thorium_node_destroy(struct thorium_node *node)
{
    ...
    thorium_tracepoint_session_destroy(&node->tracepoint_session);
...
void thorium_node_send(struct thorium_node *node, struct thorium_message *message)
{
    ...
    thorium_tracepoint_DISABLED(message, node_send_system, message);
    ...
    if (thorium_node_has_actor(node, name)) {
        ...
        thorium_tracepoint_DISABLED(message, node_send_dispatch, message);
...
void thorium_node_dispatch_message(struct thorium_node *node, struct thorium_message *message)
{
    ...
    thorium_tracepoint_DISABLED(message, node_dispatch_message, message);
...
void thorium_node_run_loop(struct thorium_node *node)
{
    ...
    while (credits > 0) {
        ...
        thorium_tracepoint_DISABLED(node, run_loop_print, &node->tracepoint_session);
        ...
        if (use_transport
            ...
            thorium_tracepoint_DISABLED(message, node_receive, &message);
        ...
        thorium_tracepoint_DISABLED(node, run_loop_receive, &node->tracepoint_session);
        ...
        thorium_tracepoint_DISABLED(node, run_loop_run, &node->tracepoint_session);
        ...
        thorium_tracepoint_DISABLED(node, run_loop_pool_work, &node->tracepoint_session);
        ...
        thorium_tracepoint_DISABLED(node, run_loop_test_requests, &node->tracepoint_session);
        ...
        thorium_tracepoint_DISABLED(node, run_loop_do_triage, &node->tracepoint_session);
...
void thorium_node_send_message(struct thorium_node *node)
{
    ...
    if (thorium_node_pull(node, &message)) {
        ...
        thorium_tracepoint_DISABLED(message, node_send, &message);
