...
#define BSAL_INPUT_OPEN_OK 0x00000f68
#define BSAL_INPUT_ERROR 0x00002a0f
#define BSAL_INPUT_ERROR_FILE_NOT_FOUND 0x00002426
#define BSAL_INPUT_ERROR_FORMAT_NOT_SUPPORTED 0x000050d8
#define BSAL_INPUT_ERROR_ALREADY_OPEN 0x00005c80
#define BSAL_INPUT_ERROR_FILE_NOT_OPEN 0x000059cc
...
#define BSAL_INPUT_COUNT_RESULT 0x000018a9
#define BSAL_INPUT_CLOSE 0x00007646
#define BSAL_INPUT_CLOSE_OK 0x00004329
